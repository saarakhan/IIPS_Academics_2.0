        ...
        <div className='hidden md:flex items-center space-x-4'>
          {session ? (
            <>
              ...
              <button onClick={handleLogout} className='bg-[#2B3333] text-[#F3F6F2] px-6 py-2 rounded-lg text-sm hover:bg-black transition-colors ml-2'>
                Logout
              </button>
            </>
          ) : (
        ...
        <div className='md:hidden bg-white shadow-lg rounded-b-lg px-4 py-3 space-y-2 text-sm'>
          ...
          <div className='pt-3 border-t border-gray-200'>
            {session ? (
              ...
              <Link to='/signin' className='block bg-[#2B3333] text-[#F3F6F2] hover:bg-black px-4 py-2 rounded text-sm text-center' onClick={() => setMenuOpen(false)}>
                Login
              </Link>
            )}
          </div>
