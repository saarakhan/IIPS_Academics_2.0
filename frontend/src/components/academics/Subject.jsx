  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (
        ...
        !event.target.closest("#department-dropdown")
      ) {
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f5f7fa] to-[#f0f4f8]">
      <div className="container mx-auto py-8 px-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-[#2b3333]">
            Available Resources
          </h2>
          <button
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-8 border border-[#e0e5ec] animate-fadeIn">
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                ...
                className="text-xs bg-[#f0f4f8] hover:bg-[#e0e5ec] text-[#003366] px-3 py-1.5 rounded-full transition-colors flex items-center"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-2">
                <label
                  htmlFor="name-filter"
                  className="text-sm font-medium text-[#2b3333] block"
                >
                  Subject Name
                </label>
              ...
              <div className="space-y-2">
                ...
                <div className="relative" id="department-dropdown">
                  ...
                  >
                    <span
                      className={
                        departmentFilter ? "text-[#2b3333]" : "text-gray-400"
                      }
                    >
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            <div className="inline-flex items-center bg-[#e9f0f8] text-[#003366] text-xs px-3 py-1 rounded-full">
              ...
              <button
                ...
                className="ml-2 hover:text-[#002855]"
              >
        ...
        {filteredSubjects.length === 0 ? (
          <div className="text-center py-16 bg-white rounded-xl shadow-sm border border-[#e0e5ec]">
            ...
            <h3 className="text-lg font-bold text-[#2b3333] mb-2">
            ...
            <button
              onClick={clearFilters}
              className="px-6 py-2 bg-[#003366] hover:bg-[#002855] text-white rounded-lg transition-colors shadow-sm"
            >
              Clear All Filters
            </button>
          </div>
            ...
            {filteredSubjects.map((subject) => (
              ...
              >
                ...
                <div className="px-5 py-3">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-[#f8f9fa] p-3 rounded-lg">
                      ...
                      <div className="text-sm font-bold text-[#2b3333]">
                        {subject.year || "Not specified"}
                      </div>
                    </div>
                    <div className="bg-[#f8f9fa] p-3 rounded-lg">
                      <p className="text-xs text-gray-500 uppercase font-medium mb-1">
                  ...
                  <div className="mt-4 flex items-center">
                    ...
                    <span className="text-sm text-gray-600">
                      Instructor:{" "}
                      <span className="font-medium text-[#2b3333]">
                        {subject.teacher}
                      </span>
                    </span>
                  </div>
                ...
                <div className="p-5 pt-3">
                  <button className="w-full bg-[#003366] hover:bg-[#002855] text-white py-2.5 rounded-lg transition-colors shadow-sm group-hover:shadow font-medium">
                    View Details
                  </button>
                </div>
              </div>
