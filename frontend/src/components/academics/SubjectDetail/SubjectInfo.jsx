        ...
        <div className='grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-[#e0e5ec]'>
          <div className='p-4'>
            <div className='flex items-center mb-1.5'>
              ...
              <h3 className='text-xs font-medium text-[#C79745]/90 uppercase'>Semester</h3>
            </div>
          ...
          <div className='p-4'>
            <div className='flex items-center mb-1.5'>
              <UserIcon className='h-4 w-4 text-[#C79745]/90 mr-2' />
              <h3 className='text-xs font-medium text-[#C79745]/90 uppercase'>Instructor</h3>
            </div>
          ...
          <div className='p-4'>
            <div className='flex items-center mb-1.5'>
              <BuildingIcon className='h-4 w-4 text-[#C79745]/90 mr-2' />
              <h3 className='text-xs font-medium text-[#C79745]/90 uppercase'>Department</h3>
            </div>
