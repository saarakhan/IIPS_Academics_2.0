  ...
  return (
    <div className="flex flex-col items-center gap-2 w-full">
      ...
      <div className="w-full bg-[#F4F9FF] p-5">
        ...
        <p className="text-center text-[#3B3838]">
          Manage your profile and see your contributions
        </p>
      </div>

      {/* Layout Wrapper with horizontal padding on mobile */}
      <div className="w-full px-4 sm:px-6">
        <div className="flex w-full max-w-7xl mx-auto justify-center gap-4 lg:gap-8 mt-8 flex-col lg:flex-row">
          {/* Profile Sidebar */}
          <div className="border-2 w-full lg:w-72 xl:w-80 flex flex-col items-center py-6 px-6 rounded-xl h-fit lg:h-[650px] bg-white shadow-[5px_7px_8px_rgba(0,0,0,0.25)]">
            ...
            <div className="relative group mb-4">
              <img
                ...
                alt="user image"
                loading="lazy"
                className={`w-24 h-24 lg:w-28 lg:h-28 rounded-full object-cover border-2 ${uploadingAvatar ? "opacity-50" : "opacity-100"
                  } transition-opacity`}
              />
              {uploadingAvatar && (
              ...
              {loading ? (
                ...
                <div className="flex justify-around text-center">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-[#C79745] text-xs lg:text-sm">
                      Downloads
                    </p>
                  </div>
                  <div className="flex flex-col items-center">
            ...
            <div className="w-full flex flex-col gap-3">
              {menuItems.map((item) => (
                <button
                  ...
                  className={`flex items-center gap-4 border-2 rounded-lg px-4 py-3 text-sm cursor-pointer transition-colors w-full ${active === item.label
